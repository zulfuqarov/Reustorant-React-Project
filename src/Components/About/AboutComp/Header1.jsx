...
const Header1 = () => {
    return (
        <div className='bg-white rounded-[50px] flex flex-row space-x-8 max-md:space-x-0 max-sm:mx-[10px] px-[60px] max-lg:px-[0] max-md:flex-col justify-center items-center'>
            <div className='basis-3/6 max-md:order-last flex flex-col max-md:justify-center max-md:items-center'>
            ...
            <div className='basis-3/6 max-md:pt-[30px]'>
                <img className='rounded-[50px]' src="https://res.cloudinary.com/dviivhiqd/image/upload/v1702279481/juicy-steak-medium-rare-beef-with-spices-grilled-vegetables_karxor.jpg" alt="" />
            </div>
        </div>
    )
}
